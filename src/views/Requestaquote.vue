<template>
  ...
  <option>Canada</option>
            ...
            <button type="submit" class="btn btn-lg text-light" style=" margin-top: 35px !important; font-size: 10px; margin-left: 420px; padding: 8px 38px; background-color: #01C881;">
  <span v-if="loader">
  ...
  <span v-else>Request a quote</span>
        ...
        <p style="color: green; margin-left: 350px;">{{ succmsg }}</p>
